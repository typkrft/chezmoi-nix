{ nix-vars, pkgs, ... }: {
  services.yabai = {
    ...
    extraConfig = ''
      ...
      yabai -m config focus_follows_mouse autofocus # autoraise #! TODO: Seems to random click on things. Check later
      ...
      yabai -m rule --add app="^(Authy Desktop|Bitwarden|System Settings|Finder)$" sticky=on layer=above manage=off 
