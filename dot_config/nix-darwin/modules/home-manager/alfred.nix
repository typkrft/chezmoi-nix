{ pkgs, config, ... }: {
  ...
  # home.file."Library/Application Support/Alfred/Alfred.alfredpreferences/workflows/firefox" = {
  #   enable = true;
  #   recursive = true;
  #   source = pkgs.fetchurl {
  #     name = "firefox-workflow";
  #     url = "https://github.com/deanishe/alfred-firefox/releases/download/v0.2.2/Firefox-Assistant-0.2.2.alfredworkflow";
  #     sha256 = "sha256-dnMY+ILpdJtk2+bC2VsWf4u/e+42Dg8z8RSU4NsdNTY=";
  #     downloadToTemp = true;
  #     recursiveHash = true;
  #     postFetch = ''
  #       mv $downloadedFile firefox-alfred.zip
  #       ${pkgs.unzip}/bin/unzip firefox-alfred.zip -x "info.plist" -d "$out"
  #     '';
  #   };
  # };
