{ pkgs, ... }: {
  ...
  programs.firefox.profiles."ff-nix" = {
    ...
    #          --window-colour:                     #${themes.dracula.hex.background}; 
    #          --secondary-colour:                  #${themes.dracula.hex.purple}; 
    #          --inverted-colour:                   #${themes.dracula.hex.foreground};
    #          --url-bar-highlight:                  #${themes.dracula.hex.comment};

    #          /* Containter Tab Colours */ 
    #          --uc-identity-color-blue:            #${themes.dracula.hex.cyan}; 
    #          --uc-identity-color-turquoise:       #${themes.dracula.hex.color13}; 
    #          --uc-identity-color-green:           #${themes.dracula.hex.green}; 
    #          --uc-identity-color-yellow:          #${themes.dracula.hex.yellow}; 
    #          --uc-identity-color-orange:          #${themes.dracula.hex.orange}; 
    #          --uc-identity-color-red:             #${themes.dracula.hex.red}; 
    #          --uc-identity-color-pink:            #${themes.dracula.hex.pink}; 
    #          --uc-identity-color-purple:          #${themes.dracula.hex.purple};
    #          --uc-identity-color-blue-muted:      #7E${themes.dracula.hex.cyan}; 
    #          --uc-identity-color-turquoise-muted: #55${themes.dracula.hex.color13}; 
    #          --uc-identity-color-green-muted:     #B8${themes.dracula.hex.green}; 
    #          --uc-identity-color-yellow-muted:    #F7${themes.dracula.hex.yellow}; 
    #          --uc-identity-color-orange-muted:    #F1${themes.dracula.hex.orange}; 
    #          --uc-identity-color-red-muted:       #FC${themes.dracula.hex.red}; 
    #          --uc-identity-color-pink-muted:      #F7${themes.dracula.hex.pink}; 
    #          --uc-identity-color-purple-muted:    #78${themes.dracula.hex.purple}; 
    ...
    #      --urlbar-popup-url-color: var(--url-bar-highlight) !important; 
